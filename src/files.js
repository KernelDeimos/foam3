...
//  { name: "foam/mlang/order/ComparatorJava", flags: ['java'] },
  ...
  { name: "foam/u2/wizard/agents/ExportMapAgent", flags: ['web'] },
  ...
  { name: 'foam/demos/heroes/Hero', flags: ['java'] },
  ...
  //{ name: 'foam/lib/parse/Action', flags: ['java'] },
//  { name: 'foam/lib/parse/ActionParser', flags: ['java'] },
...
{ name: 'foam/nanos/dig/ExternalDataAware', flags: ['java'] },
 ...
 // { name: 'foam/dao/jdbc/TestCompany', flags: ['java'] },
 // { name: 'foam/dao/jdbc/TestEmployee', flags: ['java'] },
  { name: 'foam/java/ParseTemplateTest', flags: ['java'] },
//  { name: 'foam/java/ParseTemplateTestModel', flags: ['java'] },
